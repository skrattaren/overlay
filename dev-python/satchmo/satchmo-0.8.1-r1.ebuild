...
RDEPEND=">=dev-python/django-1.0
	...
	>=dev-python/pyyaml-3.00
	dev-python/django-registration
	dev-python/django-app-plugins
	dev-python/django-threaded-multihost
	dev-python/sorl-thumbnails
	dev-python/trml2pdf
"
DEPEND="${RDEPEND}"
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-0.8-shop-l10n-utils.patch"
}
src_compile() {
